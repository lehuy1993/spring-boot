...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/booking.css">
						...
						<div id="collapseOne" class="collapse show "
							...
							<div class="card-body  " style="font-size: 15px;">
								...
								<div class="value ">
									...
									<br />
									 <p id = "scource" class="text-success">${scource}</p>
									<br />
									...
									<table class="info-wrapper">
										<thead>
											<tr class="block-box">
												...
												<td class="price text-info"><span class="price">0,00&nbsp;₫</span></td>

											</tr>
											<tr class="block-box">
												<td class="label">Ticket</td>
												<td class="ticket text-success"><span class="ticket">0,00&nbsp;₫</span></td>

											</tr>
											<tr class="block-box">
												<td class="label">Tổng tiền</td>
												<td class="totalMoney text-danger "><span class="totalMoney">0,00&nbsp;₫</span></td>
			...
			<a class="btn-left" href="${pageContext.request.contextPath}/employee/showtime" title="Previous">Previous</a>
...
<jsp:include page="../index/footer.jsp"></jsp:include>
		...
		<script src="<%=request.getContextPath()%>/resources/js/admin/admin_ticket-info.js">
