			...
			<div class="col-xs-12" style="background-color: white">
				...
				<div class="card-body">
					...
					<c:if test="${not empty msg }">
						<div id="msg" class="callout callout-danger">
							<p>${msg }</p>
						</div>
					</c:if>
						<spring:url value="/admin" var="uploadUrl" />
						<form:form action="${uploadUrl}/edit-movie/${ movieForm.movieId}" method="POST" modelAttribute="movieForm"  enctype="multipart/form-data">
							<div class="edit_image">
								<img class="img-responsive center-block" alt="Logo" src="${pageContext.request.contextPath}/resources/img/${movieForm.smallImage}">
							</div>
							...
							<div class="form-group">
								...
								<div class="row">
									<c:forEach items="${types}" var="type" varStatus="loop">
										...
										<c:choose>
										   <c:when test="${ not empty  type.movie}">
										      <form:checkbox class="form-check-input" path="types" value="${type.typeId}" checked="checked"/>
							...
							<div class="form-group">
								...
								<form:select class="form-control" id="editCinemaRoom" name="cinemaRoomId" path="cinemaRoomId">
							...
							<div>
								...
								<form:hidden path="smallImage"/>
								<form:hidden path="largeImage"/>
