if (Cookies.get('tickets') == null) {
	...
	var source = $('#scource').html();
	$('.minicart-wrapper .block-box .ticket').html(formatMoney(source)+ "\u00a0\u20ab");
	
	var totalMoney = boxprice - source;
	$('.minicart-wrapper .block-box .totalMoney').html(formatMoney(totalMoney)+ "\u00a0\u20ab");
